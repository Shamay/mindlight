...
export const connect = async () => {
  ...
  console.log('Login successful, status info to be printed on changes to status');
...
export const focusProbability = () => {
  const focusObservable = Config.environment.isTest() ? simulatedFocus : mind.focus();
